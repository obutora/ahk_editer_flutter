...
class FileController {
  ...
  static Future<void> saveDrugHistory(DrugHistory history) async {
    final String dir = PathController.getSaveJsonFilePath(history.hotString);
  ...
  static deleteJson(DrugHistory history) {
    final Directory dir =
        Directory(PathController.getSaveJsonFilePath(history.hotString));
  ...
  static Future<void> saveAhk(String ahkBody) async {
    ...
    final String dir = PathController.getAhkFilePath();
    final File file = File(dir);
